...
func main() {
	...
	s1, _ := strconv.Atoi(read())
	e1, _ := strconv.Atoi(read())
	ans += float64(s1) * float64(e1) / 10

	s2, _ := strconv.Atoi(read())
	e2, _ := strconv.Atoi(read())
	ans += float64(s2) * float64(e2) / 10

	s3, _ := strconv.Atoi(read())
	e3, _ := strconv.Atoi(read())
	ans += float64(s3) * float64(e3) / 10
